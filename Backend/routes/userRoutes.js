...
const { getUserInfo, changePassword, verifyPassword, updateUserProfilePic, getUserProfilePic, getBotanists } = require('../controllers/userController');
...
router.get('/botanists', authenticateToken, getBotanists);
