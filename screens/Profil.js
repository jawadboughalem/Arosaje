...
const styles = StyleSheet.create({
  ...
  avatarIcon: {
    width: 50,
    height: 50,
    marginBottom: -150, // Adjusted to place it closer to the profile image
  ...
  button: {
    backgroundColor: '#5DB075', // Updated button color
    padding: 10,
    borderRadius: 5,
  },
  buttonText: {
  ...
  selectedTabButton: {
    backgroundColor: '#5DB075', // Updated selected tab button color
  },
  tabButtonText: {
    color: '#333',
    fontSize: 16,
